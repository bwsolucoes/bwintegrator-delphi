...
begin{>>BWIntegrator} IntegratorEnterProcess(79); try try {BWIntegrator>>}
...
{>>BWIntegrator} finally IntegratorExitProcess(79); end; except on e: Exception do begin IntegratorHandleException(79, e); end; end; {BWIntegrator>>}end;

procedure TDraftProposalForm.BindSourceDBLineItemsSubDataSourceDataChange(
  Sender: TObject; Field: TField);
begin{>>BWIntegrator} IntegratorEnterProcess(80); try try {BWIntegrator>>}
...
{>>BWIntegrator} finally IntegratorExitProcess(80); end; except on e: Exception do begin IntegratorHandleException(80, e); end; end; {BWIntegrator>>}end;

procedure TDraftProposalForm.PreviewButtonClick(Sender: TObject);
var
  LDoc: Variant;
begin{>>BWIntegrator} IntegratorEnterProcess(81); try try {BWIntegrator>>}
  ...
  LDoc.Close;
{>>BWIntegrator} finally IntegratorExitProcess(81); end; except on e: Exception do begin IntegratorHandleException(81, e); end; end; {BWIntegrator>>}end;


procedure TDraftProposalForm.CancelButtonClick(Sender: TObject);
begin{>>BWIntegrator} IntegratorEnterProcess(82); try try {BWIntegrator>>}
  Close;
{>>BWIntegrator} finally IntegratorExitProcess(82); end; except on e: Exception do begin IntegratorHandleException(82, e); end; end; {BWIntegrator>>}end;

procedure TDraftProposalForm.BackButtonClick(Sender: TObject);
begin{>>BWIntegrator} IntegratorEnterProcess(83); try try {BWIntegrator>>}
  DraftCardPanel.PreviousCard;
{>>BWIntegrator} finally IntegratorExitProcess(83); end; except on e: Exception do begin IntegratorHandleException(83, e); end; end; {BWIntegrator>>}end;

function TDraftProposalForm.GenerateReport(ADataSet, ALineItemsDataSet: TDataSet): String;
var
  LReport: TStringList;
begin{>>BWIntegrator} IntegratorEnterProcess(84); try try {BWIntegrator>>}
...
{>>BWIntegrator} finally IntegratorExitProcess(84); end; except on e: Exception do begin IntegratorHandleException(84, e); end; end; {BWIntegrator>>}end;

 procedure TDraftProposalForm.PreviewCardClick(Sender: TObject);
begin{>>BWIntegrator} IntegratorEnterProcess(85); try try {BWIntegrator>>}
  DraftCardPanel.PreviousCard;
{>>BWIntegrator} finally IntegratorExitProcess(85); end; except on e: Exception do begin IntegratorHandleException(85, e); end; end; {BWIntegrator>>}end;

procedure TDraftProposalForm.SaveProposalButtonClick(Sender: TObject);
var
LReportStream: TStringStream;
begin{>>BWIntegrator} IntegratorEnterProcess(86); try try {BWIntegrator>>}
  ...
  DraftCardPanel.PreviousCard;
  Close;
{>>BWIntegrator} finally IntegratorExitProcess(86); end; except on e: Exception do begin IntegratorHandleException(86, e); end; end; {BWIntegrator>>}end;

procedure TDraftProposalForm.AddReportLine(const S: String; AStrings: TStrings);
begin{>>BWIntegrator} IntegratorEnterProcess(87); try try {BWIntegrator>>}
  AStrings.Append(S);
{>>BWIntegrator} finally IntegratorExitProcess(87); end; except on e: Exception do begin IntegratorHandleException(87, e); end; end; {BWIntegrator>>}end;

procedure TDraftProposalForm.AddReportHeaderLine(const S1, S2: String; AStrings: TStrings);
begin{>>BWIntegrator} IntegratorEnterProcess(88); try try {BWIntegrator>>}
...
{>>BWIntegrator} finally IntegratorExitProcess(88); end; except on e: Exception do begin IntegratorHandleException(88, e); end; end; {BWIntegrator>>}end;

procedure TDraftProposalForm.AddReportSubHeader(const S1: String; AStrings: TStrings);
begin{>>BWIntegrator} IntegratorEnterProcess(89); try try {BWIntegrator>>}
...
{>>BWIntegrator} finally IntegratorExitProcess(89); end; except on e: Exception do begin IntegratorHandleException(89, e); end; end; {BWIntegrator>>}end;

procedure TDraftProposalForm.AddReportSubHeaderInfo(const S1, S2, S3, S4: String; AStrings: TStrings);
begin{>>BWIntegrator} IntegratorEnterProcess(90); try try {BWIntegrator>>}
  AStrings.Append('<tr class="row header ltblue"><td align="left"><h4>'
                    ...
                    +'</h4></td><td></td></tr>');
{>>BWIntegrator} finally IntegratorExitProcess(90); end; except on e: Exception do begin IntegratorHandleException(90, e); end; end; {BWIntegrator>>}end;

procedure TDraftProposalForm.AddReportFooterLine(const S1: String; AStrings: TStrings);
begin{>>BWIntegrator} IntegratorEnterProcess(91); try try {BWIntegrator>>}
  AStrings.Append('<tr class="row header blue"><td colspan="2"><h3><p class="bg-primary" align="center">' + S1 + '</p></h3></td></tr>');
{>>BWIntegrator} finally IntegratorExitProcess(91); end; except on e: Exception do begin IntegratorHandleException(91, e); end; end; {BWIntegrator>>}end;

procedure TDraftProposalForm.AddInvoiceSection(ALineItemsDataSet: TDataSet; AStrings: TStrings);
begin{>>BWIntegrator} IntegratorEnterProcess(92); try try {BWIntegrator>>}
...
{>>BWIntegrator} finally IntegratorExitProcess(92); end; except on e: Exception do begin IntegratorHandleException(92, e); end; end; {BWIntegrator>>}end;

procedure TDraftProposalForm.AddInvoiceData(AName, APrice, AQuantity: String; AStrings: TStrings);
begin{>>BWIntegrator} IntegratorEnterProcess(93); try try {BWIntegrator>>}
  AddReportLine(InvoiceTRStart + AName + InvoiceTRMid + APrice + InvoiceTRMid + AQuantity + InvoiceTREnd, AStrings);
{>>BWIntegrator} finally IntegratorExitProcess(93); end; except on e: Exception do begin IntegratorHandleException(93, e); end; end; {BWIntegrator>>}end;
